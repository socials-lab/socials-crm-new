...
// Lead source types for analytics
export type LeadSource = 'website' | 'linkedin' | 'referral' | 'cold_outreach' | 'event' | 'landing_page' | 'other';
...
export interface NewLeadEntry {
  ...
  is_won: boolean; // Did they convert to won?
  source: LeadSource;
  source_detail?: string; // e.g. "homepage", "pricing-page", "webinar-jan-2026"
}
...
// Includes source tracking to analyze which channels bring best leads
export const MOCK_NEW_LEAD_ENTRIES: NewLeadEntry[] = [
  // August 2025: 10 new leads, 3 qualified (30%), 2 won
  // Referrals: 2 leads, 2 qualified, 2 won (100% quality) - best source
  // Website: 4 leads, 1 qualified, 0 won (25% quality)
  // LinkedIn: 2 leads, 0 qualified (0% quality) - worst
  // Landing page: 2 leads, 0 qualified (0% quality)
  { id: generateId(), lead_id: 'lead-a1', entered_at: '2025-08-01T09:00:00Z', value: 65000, is_qualified: true, is_won: true, source: 'referral', source_detail: 'client-abc' },
  { id: generateId(), lead_id: 'lead-a2', entered_at: '2025-08-03T10:00:00Z', value: 45000, is_qualified: true, is_won: true, source: 'referral', source_detail: 'partner-xyz' },
  { id: generateId(), lead_id: 'lead-a3', entered_at: '2025-08-06T11:00:00Z', value: 80000, is_qualified: true, is_won: false, source: 'website', source_detail: 'contact-form' },
  { id: generateId(), lead_id: 'lead-bad-a1', entered_at: '2025-08-04T14:00:00Z', value: 15000, is_qualified: false, is_won: false, source: 'website', source_detail: 'pricing-page' },
  { id: generateId(), lead_id: 'lead-bad-a2', entered_at: '2025-08-07T09:00:00Z', value: 20000, is_qualified: false, is_won: false, source: 'linkedin', source_detail: 'dm-outreach' },
  { id: generateId(), lead_id: 'lead-bad-a3', entered_at: '2025-08-10T16:00:00Z', value: 10000, is_qualified: false, is_won: false, source: 'linkedin', source_detail: 'ad-campaign' },
  { id: generateId(), lead_id: 'lead-bad-a4', entered_at: '2025-08-12T11:00:00Z', value: 25000, is_qualified: false, is_won: false, source: 'website', source_detail: 'blog' },
  { id: generateId(), lead_id: 'lead-bad-a5', entered_at: '2025-08-18T10:00:00Z', value: 18000, is_qualified: false, is_won: false, source: 'landing_page', source_detail: 'ppc-audit' },
  { id: generateId(), lead_id: 'lead-bad-a6', entered_at: '2025-08-22T14:00:00Z', value: 12000, is_qualified: false, is_won: false, source: 'landing_page', source_detail: 'ebook-download' },
  { id: generateId(), lead_id: 'lead-bad-a7', entered_at: '2025-08-28T09:00:00Z', value: 8000, is_qualified: false, is_won: false, source: 'website', source_detail: 'homepage' },

  // September 2025: 12 new leads, 4 qualified (33%), 2 won
  { id: generateId(), lead_id: 'lead-b1', entered_at: '2025-09-01T09:00:00Z', value: 120000, is_qualified: true, is_won: true, source: 'referral', source_detail: 'client-def' },
  { id: generateId(), lead_id: 'lead-b2', entered_at: '2025-09-04T10:00:00Z', value: 55000, is_qualified: true, is_won: false, source: 'website', source_detail: 'case-study' },
  { id: generateId(), lead_id: 'lead-b3', entered_at: '2025-09-08T11:00:00Z', value: 40000, is_qualified: true, is_won: false, source: 'event', source_detail: 'marketing-conf-2025' },
  { id: generateId(), lead_id: 'lead-b4', entered_at: '2025-09-11T14:00:00Z', value: 75000, is_qualified: true, is_won: true, source: 'referral', source_detail: 'partner-abc' },
  { id: generateId(), lead_id: 'lead-bad-b1', entered_at: '2025-09-02T14:00:00Z', value: 15000, is_qualified: false, is_won: false, source: 'cold_outreach', source_detail: 'email-campaign' },
  { id: generateId(), lead_id: 'lead-bad-b2', entered_at: '2025-09-06T09:00:00Z', value: 22000, is_qualified: false, is_won: false, source: 'linkedin', source_detail: 'inmail' },
  { id: generateId(), lead_id: 'lead-bad-b3', entered_at: '2025-09-10T16:00:00Z', value: 9000, is_qualified: false, is_won: false, source: 'landing_page', source_detail: 'free-consultation' },
  { id: generateId(), lead_id: 'lead-bad-b4', entered_at: '2025-09-15T11:00:00Z', value: 18000, is_qualified: false, is_won: false, source: 'website', source_detail: 'blog' },
  { id: generateId(), lead_id: 'lead-bad-b5', entered_at: '2025-09-19T10:00:00Z', value: 14000, is_qualified: false, is_won: false, source: 'cold_outreach', source_detail: 'linkedin-message' },
  { id: generateId(), lead_id: 'lead-bad-b6', entered_at: '2025-09-22T14:00:00Z', value: 11000, is_qualified: false, is_won: false, source: 'landing_page', source_detail: 'webinar-signup' },
  { id: generateId(), lead_id: 'lead-bad-b7', entered_at: '2025-09-25T09:00:00Z', value: 7000, is_qualified: false, is_won: false, source: 'website', source_detail: 'contact-form' },
  { id: generateId(), lead_id: 'lead-bad-b8', entered_at: '2025-09-28T16:00:00Z', value: 13000, is_qualified: false, is_won: false, source: 'linkedin', source_detail: 'post-comment' },

  // October 2025: 8 new leads, 3 qualified (37%), 1 won
  { id: generateId(), lead_id: 'lead-c1', entered_at: '2025-10-02T09:00:00Z', value: 95000, is_qualified: true, is_won: true, source: 'referral', source_detail: 'client-ghi' },
  { id: generateId(), lead_id: 'lead-c2', entered_at: '2025-10-06T10:00:00Z', value: 60000, is_qualified: true, is_won: false, source: 'event', source_detail: 'ecommerce-summit' },
  { id: generateId(), lead_id: 'lead-c3', entered_at: '2025-10-12T11:00:00Z', value: 30000, is_qualified: true, is_won: false, source: 'website', source_detail: 'services-page' },
  { id: generateId(), lead_id: 'lead-bad-c1', entered_at: '2025-10-04T14:00:00Z', value: 16000, is_qualified: false, is_won: false, source: 'cold_outreach', source_detail: 'phone' },
  { id: generateId(), lead_id: 'lead-bad-c2', entered_at: '2025-10-09T09:00:00Z', value: 19000, is_qualified: false, is_won: false, source: 'linkedin', source_detail: 'ad' },
  { id: generateId(), lead_id: 'lead-bad-c3', entered_at: '2025-10-16T16:00:00Z', value: 12000, is_qualified: false, is_won: false, source: 'landing_page', source_detail: 'black-friday' },
  { id: generateId(), lead_id: 'lead-bad-c4', entered_at: '2025-10-22T11:00:00Z', value: 8000, is_qualified: false, is_won: false, source: 'website', source_detail: 'blog' },
  { id: generateId(), lead_id: 'lead-bad-c5', entered_at: '2025-10-28T10:00:00Z', value: 14000, is_qualified: false, is_won: false, source: 'other', source_detail: 'clutch-listing' },

  // November 2025: 9 new leads, 3 qualified (33%), 1 won
  { id: generateId(), lead_id: 'lead-d1', entered_at: '2025-11-03T09:00:00Z', value: 85000, is_qualified: true, is_won: true, source: 'referral', source_detail: 'agency-partner' },
  { id: generateId(), lead_id: 'lead-d2', entered_at: '2025-11-08T10:00:00Z', value: 50000, is_qualified: true, is_won: false, source: 'website', source_detail: 'pricing-page' },
  { id: generateId(), lead_id: 'lead-d3', entered_at: '2025-11-16T11:00:00Z', value: 35000, is_qualified: true, is_won: false, source: 'event', source_detail: 'networking-event' },
  { id: generateId(), lead_id: 'lead-bad-d1', entered_at: '2025-11-02T14:00:00Z', value: 17000, is_qualified: false, is_won: false, source: 'cold_outreach', source_detail: 'email' },
  { id: generateId(), lead_id: 'lead-bad-d2', entered_at: '2025-11-06T09:00:00Z', value: 21000, is_qualified: false, is_won: false, source: 'linkedin', source_detail: 'connection-request' },
  { id: generateId(), lead_id: 'lead-bad-d3', entered_at: '2025-11-12T16:00:00Z', value: 11000, is_qualified: false, is_won: false, source: 'landing_page', source_detail: 'newsletter' },
  { id: generateId(), lead_id: 'lead-bad-d4', entered_at: '2025-11-20T11:00:00Z', value: 9000, is_qualified: false, is_won: false, source: 'website', source_detail: 'blog' },
  { id: generateId(), lead_id: 'lead-bad-d5', entered_at: '2025-11-24T10:00:00Z', value: 15000, is_qualified: false, is_won: false, source: 'linkedin', source_detail: 'group-post' },
  { id: generateId(), lead_id: 'lead-bad-d6', entered_at: '2025-11-28T14:00:00Z', value: 13000, is_qualified: false, is_won: false, source: 'other', source_detail: 'google-partner' },

  // December 2025: 11 new leads, 4 qualified (36%), 2 won
  { id: generateId(), lead_id: 'lead-e1', entered_at: '2025-12-01T09:00:00Z', value: 110000, is_qualified: true, is_won: true, source: 'referral', source_detail: 'client-jkl' },
  { id: generateId(), lead_id: 'lead-e2', entered_at: '2025-12-04T10:00:00Z', value: 70000, is_qualified: true, is_won: false, source: 'website', source_detail: 'case-study' },
  { id: generateId(), lead_id: 'lead-e3', entered_at: '2025-12-08T11:00:00Z', value: 55000, is_qualified: true, is_won: true, source: 'event', source_detail: 'year-end-summit' },
  { id: generateId(), lead_id: 'lead-e4', entered_at: '2025-12-13T14:00:00Z', value: 42000, is_qualified: true, is_won: false, source: 'website', source_detail: 'services-page' },
  { id: generateId(), lead_id: 'lead-bad-e1', entered_at: '2025-12-02T14:00:00Z', value: 16000, is_qualified: false, is_won: false, source: 'cold_outreach', source_detail: 'email-blast' },
  { id: generateId(), lead_id: 'lead-bad-e2', entered_at: '2025-12-06T09:00:00Z', value: 23000, is_qualified: false, is_won: false, source: 'linkedin', source_detail: 'sponsored-content' },
  { id: generateId(), lead_id: 'lead-bad-e3', entered_at: '2025-12-11T16:00:00Z', value: 10000, is_qualified: false, is_won: false, source: 'landing_page', source_detail: 'year-end-promo' },
  { id: generateId(), lead_id: 'lead-bad-e4', entered_at: '2025-12-16T11:00:00Z', value: 19000, is_qualified: false, is_won: false, source: 'website', source_detail: 'homepage' },
  { id: generateId(), lead_id: 'lead-bad-e5', entered_at: '2025-12-20T10:00:00Z', value: 14000, is_qualified: false, is_won: false, source: 'linkedin', source_detail: 'ad' },
  { id: generateId(), lead_id: 'lead-bad-e6', entered_at: '2025-12-24T14:00:00Z', value: 8000, is_qualified: false, is_won: false, source: 'other', source_detail: 'upwork' },
  { id: generateId(), lead_id: 'lead-bad-e7', entered_at: '2025-12-28T09:00:00Z', value: 12000, is_qualified: false, is_won: false, source: 'landing_page', source_detail: 'new-year-offer' },

  // January 2026: 10 new leads, 3 qualified (30%), 1 won
  { id: generateId(), lead_id: 'lead-f1', entered_at: '2026-01-05T09:00:00Z', value: 90000, is_qualified: true, is_won: true, source: 'referral', source_detail: 'client-mno' },
  { id: generateId(), lead_id: 'lead-f2', entered_at: '2026-01-08T10:00:00Z', value: 65000, is_qualified: true, is_won: false, source: 'website', source_detail: 'contact-form' },
  { id: generateId(), lead_id: 'lead-f3', entered_at: '2026-01-18T11:00:00Z', value: 42000, is_qualified: true, is_won: false, source: 'event', source_detail: 'webinar-jan-2026' },
  { id: generateId(), lead_id: 'lead-bad-f1', entered_at: '2026-01-03T14:00:00Z', value: 18000, is_qualified: false, is_won: false, source: 'cold_outreach', source_detail: 'email' },
  { id: generateId(), lead_id: 'lead-bad-f2', entered_at: '2026-01-07T09:00:00Z', value: 22000, is_qualified: false, is_won: false, source: 'linkedin', source_detail: 'inmail' },
  { id: generateId(), lead_id: 'lead-bad-f3', entered_at: '2026-01-12T16:00:00Z', value: 9000, is_qualified: false, is_won: false, source: 'landing_page', source_detail: 'q1-campaign' },
  { id: generateId(), lead_id: 'lead-bad-f4', entered_at: '2026-01-16T11:00:00Z', value: 15000, is_qualified: false, is_won: false, source: 'website', source_detail: 'blog' },
  { id: generateId(), lead_id: 'lead-bad-f5', entered_at: '2026-01-21T10:00:00Z', value: 13000, is_qualified: false, is_won: false, source: 'linkedin', source_detail: 'post' },
  { id: generateId(), lead_id: 'lead-bad-f6', entered_at: '2026-01-24T14:00:00Z', value: 11000, is_qualified: false, is_won: false, source: 'other', source_detail: 'clutch' },
  { id: generateId(), lead_id: 'lead-bad-f7', entered_at: '2026-01-26T09:00:00Z', value: 7000, is_qualified: false, is_won: false, source: 'landing_page', source_detail: 'free-audit' },
];
