...
const DEFAULT_TEMPLATES: Record<string, Omit<EmailTemplate, 'id' | 'updated_at' | 'updated_by'>> = {
  send_offer: {
    ...
    available_variables: ['contact_name', 'company', 'domain', 'services_list', 'price_summary', 'offer_url_line', 'sender_name', 'sender_position', 'sender_email', 'sender_phone'],
  },
  send_onboarding_form: {
    ...
    available_variables: ['contact_name', 'company', 'domain', 'url'],
  },
  request_access: {
  ...
  send_approval: {
    ...
    available_variables: ['work_name', 'work_description', 'hours_line', 'amount', 'engagement_line', 'colleague_line', 'url'],
  },
  send_modification: {
    ...
    available_variables: ['greeting', 'client', 'type', 'change_type', 'change_details', 'effective_from', 'upgrade_link', 'valid_until', 'sender_name', 'sender_position', 'sender_email', 'sender_phone'],
  },
  interview_invite: {
...
export function useEmailTemplates() {
  ...
  const fillTemplate = (key: string, variables: Record<string, string>): { subject: string; body: string } => {
