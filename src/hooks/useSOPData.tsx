...
const demoArticles: SOPArticle[] = [
  { id: 'art-1', category_id: 'cat-1', title: 'Jak nastavit nového klienta v CRM', content: '<h1>Nastavení nového klienta</h1><p>Po podpisu smlouvy je potřeba klienta správně zavést do systému.</p>', search_text: 'Nastavení nového klienta', tags: ['onboarding', 'klient', 'CRM'], sort_order: 0, is_published: true, owner_id: null, attachments: [], view_count: 42, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-2', category_id: 'cat-1', title: 'První brief s klientem', content: '<h1>První brief</h1><p>Postup pro vedení prvního briefu.</p>', search_text: 'První brief s klientem', tags: ['onboarding', 'brief', 'meeting'], sort_order: 1, is_published: true, owner_id: null, attachments: [], view_count: 38, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-3', category_id: 'cat-2', title: 'Spuštění Google Ads kampaně', content: '<h1>Spuštění Google Ads</h1><p>Jak připravit a spustit novou kampaň.</p>', search_text: 'Spuštění Google Ads kampaně', tags: ['google-ads', 'PPC', 'kampaně'], sort_order: 0, is_published: true, owner_id: null, attachments: [], view_count: 35, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-4', category_id: 'cat-2', title: 'Meta Ads setup a best practices', content: '<h1>Meta Ads Setup</h1><p>Nastavení Facebook a Instagram reklam.</p>', search_text: 'Meta Ads setup', tags: ['meta-ads', 'PPC', 'facebook'], sort_order: 1, is_published: true, owner_id: null, attachments: [], view_count: 29, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-5', category_id: 'cat-3', title: 'Jak správně vyplnit vícepráce', content: '<h1>Vyplnění víceprací</h1><p>Vícepráce musí být schválena.</p>', search_text: 'Vyplnění víceprací', tags: ['vícepráce', 'fakturace', 'proces'], sort_order: 0, is_published: true, owner_id: null, attachments: [], view_count: 27, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-6', category_id: 'cat-3', title: 'Žádost o dovolenou', content: '<h1>Dovolená</h1><p>Jak si zažádat o dovolenou.</p>', search_text: 'Žádost o dovolenou', tags: ['HR', 'dovolená', 'proces'], sort_order: 1, is_published: true, owner_id: null, attachments: [], view_count: 24, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-7', category_id: 'cat-4', title: 'Tvorba content plánu', content: '<h1>Content plán</h1><p>Postup pro tvorbu content plánu.</p>', search_text: 'Tvorba content plánu', tags: ['content', 'social-media', 'plánování'], sort_order: 0, is_published: true, owner_id: null, attachments: [], view_count: 21, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-8', category_id: 'cat-4', title: 'Schvalovací proces příspěvků', content: '<h1>Schvalování</h1><p>Jak probíhá schvalování.</p>', search_text: 'Schvalovací proces příspěvků', tags: ['content', 'schvalování', 'klient'], sort_order: 1, is_published: true, owner_id: null, attachments: [], view_count: 18, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-9', category_id: 'cat-5', title: 'Vystavení faktury v systému', content: '<h1>Fakturace</h1><p>Jak vystavit fakturu.</p>', search_text: 'Vystavení faktury v systému', tags: ['fakturace', 'finance', 'proces'], sort_order: 0, is_published: true, owner_id: null, attachments: [], view_count: 15, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-10', category_id: 'cat-6', title: 'Kvalifikace nového leadu', content: '<h1>Kvalifikace leadu</h1><p>Jak kvalifikovat lead.</p>', search_text: 'Kvalifikace nového leadu', tags: ['lead', 'prodej', 'kvalifikace'], sort_order: 0, is_published: true, owner_id: null, attachments: [], view_count: 33, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-11', category_id: 'cat-6', title: 'Příprava nabídky pro klienta', content: '<h1>Nabídka</h1><p>Jak připravit nabídku.</p>', search_text: 'Příprava nabídky', tags: ['nabídka', 'prodej', 'klient'], sort_order: 1, is_published: true, owner_id: null, attachments: [], view_count: 31, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-12', category_id: 'cat-7', title: 'Řešení reklamace klienta', content: '<h1>Reklamace</h1><p>Postup při reklamaci.</p>', search_text: 'Řešení reklamace', tags: ['reklamace', 'servis', 'escalace'], sort_order: 0, is_published: true, owner_id: null, attachments: [], view_count: 12, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-13', category_id: 'cat-8', title: 'Nastavení Google Analytics 4', content: '<h1>GA4</h1><p>Jak nastavit GA4.</p>', search_text: 'Nastavení Google Analytics 4', tags: ['analytics', 'GA4', 'nástroje'], sort_order: 0, is_published: true, owner_id: null, attachments: [], view_count: 20, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-14', category_id: 'cat-8', title: 'Google Tag Manager – základní setup', content: '<h1>GTM Setup</h1><p>Základní nastavení GTM.</p>', search_text: 'Google Tag Manager', tags: ['GTM', 'tracking', 'nástroje'], sort_order: 1, is_published: true, owner_id: null, attachments: [], view_count: 17, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-15', category_id: 'cat-9', title: 'Onboarding nového kolegy', content: '<h1>Onboarding kolegy</h1><p>Checklist pro nového kolegu.</p>', search_text: 'Onboarding nového kolegy', tags: ['HR', 'onboarding', 'tým'], sort_order: 0, is_published: true, owner_id: null, attachments: [], view_count: 26, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-16', category_id: 'cat-10', title: 'Práce s brand manuálem klienta', content: '<h1>Brand manuál</h1><p>Jak pracovat s brand manuálem.</p>', search_text: 'Brand manuál', tags: ['brand', 'design', 'guidelines'], sort_order: 0, is_published: true, owner_id: null, attachments: [], view_count: 9, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-17', category_id: 'cat-11', title: 'Příprava měsíčního reportu', content: '<h1>Report</h1><p>Jak připravit report.</p>', search_text: 'Měsíční report', tags: ['report', 'analytika', 'KPI'], sort_order: 0, is_published: true, owner_id: null, attachments: [], view_count: 22, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-18', category_id: 'cat-12', title: 'Keyword research postup', content: '<h1>Keyword Research</h1><p>Jak provést keyword research.</p>', search_text: 'Keyword research', tags: ['SEO', 'keyword', 'obsah'], sort_order: 0, is_published: true, owner_id: null, attachments: [], view_count: 14, created_by: null, updated_by: null, created_at: '', updated_at: '' },
  { id: 'art-19', category_id: 'cat-12', title: 'Obsahový audit webu', content: '<h1>Obsahový audit</h1><p>Postup pro audit.</p>', search_text: 'Obsahový audit', tags: ['SEO', 'audit', 'obsah'], sort_order: 1, is_published: true, owner_id: null, attachments: [], view_count: 11, created_by: null, updated_by: null, created_at: '', updated_at: '' },
];
