...
const INITIAL_MOCK_APPLICANTS: Applicant[] = [
  {
    ...
    avatar_url: null,
    interview_invite_sent_at: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
    rejection_sent_at: null,
    onboarding_sent_at: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(),
    onboarding_completed_at: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
    converted_to_colleague_id: null,
    contract_sent_at: null,
    contract_signed_at: null,
    buddy_id: null,
    buddy_meeting_done: true,
  ...
  },
  {
    ...
    cover_letter: 'Dobrý den,\n\nráda bych se přihlásila na pozici Social Media Specialist. Mám zkušenosti se správou sociálních sítí pro několik značek.\n\nS pozdravem,\nTereza Testovací',
    cv_url: null,
    video_url: null,
    portfolio_url: null,
    ai_usage: null,
  ...
  {
    id: 'mock-applicant-3',
    full_name: 'Marek Svoboda',
    email: 'marek.svoboda@gmail.com',
    phone: '+420 722 456 789',
    position: 'PPC Specialist',
    cover_letter: 'Dobrý den, mám zájem o pozici PPC Specialisty. Rád bych u vás rozvíjel své zkušenosti s Google Ads.',
    cv_url: null,
    video_url: null,
    portfolio_url: null,
    ai_usage: null,
