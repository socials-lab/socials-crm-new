export const ALL_PAGES = [
  ...
  { id: 'offer-management', label: 'Nabídka', emoji: '📄' },
  // Práce & dodávka
...
export const PAGE_GROUPS = [
  ...
  { label: 'Obchodní proces', pages: ['leads', 'prospects', 'clients', 'contacts', 'engagements', 'modifications', 'broadcasts', 'offer-management'] },
