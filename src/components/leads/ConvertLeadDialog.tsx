...
const convertSchema = z.object({
  ...
  website: z.string().min(1, 'Web je povinný'),
  ...
  billing_zip: z.string().min(1, 'PSČ je povinné'),
  billing_country: z.string().min(1, 'Fakturační země je povinná'),
  billing_email: z.string().email('Neplatný fakturační email').min(1, 'Fakturační email je povinný'),
  // Contact
  contact_name: z.string().min(1, 'Jméno kontaktu je povinné'),
  contact_position: z.string().min(1, 'Pozice je povinná'),
  contact_email: z.string().email('Neplatný email kontaktu').min(1, 'Email kontaktu je povinný'),
  contact_phone: z.string().min(1, 'Telefon kontaktu je povinný'),
  ...
  start_date: z.string().min(1, 'Datum zahájení je povinné'),
