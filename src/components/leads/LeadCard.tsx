      ...
      <CardContent className="p-2 space-y-1.5">
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-center gap-1.5 min-w-0">
            ...
            <span className="font-medium text-sm leading-tight line-clamp-2 break-words">{lead.company_name}</span>
          </div>
                ...
                <div className="flex flex-wrap gap-0.5 flex-1 min-w-0">
                  {hasServices ? (
                    <>
                      ...
                      {lead.potential_services.some((service) => service.intro_discount_percent) && (
                        <Badge
                          variant="outline"
                          className="text-[10px] px-1 py-0 h-4 bg-amber-500/10 text-amber-700 border-amber-500/30"
                        >
                          Sleva
                        </Badge>
                      )}
