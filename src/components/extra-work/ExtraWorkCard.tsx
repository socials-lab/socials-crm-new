        ...
        <CardContent className="p-4">
          <div className="space-y-3">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 pt-1 min-w-0">
              ...
              <div className="w-full grid grid-cols-1 gap-2 justify-start max-w-full lg:flex lg:flex-wrap lg:justify-end">
                {isPending && (
                  <>
                    {onDelete && (
                    ...
                    {onEdit && (
                      <Button variant="ghost" size="sm" className="h-auto min-h-8 w-full lg:w-auto whitespace-normal text-left justify-start lg:justify-center py-2" onClick={() => onEdit(work)}>
                        <Pencil className="h-3.5 w-3.5 mr-1" />
                        Upravit
                      </Button>
                    )}
                    {onSendApproval && (
                      <Button size="sm" className="h-auto min-h-8 w-full lg:w-auto whitespace-normal text-left justify-start lg:justify-center py-2" onClick={() => onSendApproval(work)}>
                ...
                {isWaitingForClient && (
                  <>
                    ...
                    {onSendApproval && (
                      <Button variant="outline" size="sm" className="h-auto min-h-8 w-full lg:w-auto whitespace-normal text-left justify-start lg:justify-center py-2" onClick={() => onSendApproval(work)}>
                        <Mail className="h-3.5 w-3.5 mr-1" />
                        Odeslat email
                      </Button>
                    )}
                    <Button variant="outline" size="sm" className="h-auto min-h-8 w-full lg:w-auto whitespace-normal text-left justify-start lg:justify-center py-2" onClick={handleCopyLink}>
                      {linkCopied ? (
                ...
                {isClientApproved && (
                  <Button size="sm" className="h-auto min-h-8 w-full lg:w-auto whitespace-normal text-left justify-start lg:justify-center py-2" onClick={handleMarkActive}>
                ...
                {work.status === 'in_progress' && !isClientApproved && onUpdate && (
                  <Button size="sm" className="h-auto min-h-8 w-full lg:w-auto whitespace-normal text-left justify-start lg:justify-center py-2" onClick={handleMoveToInvoice}>
