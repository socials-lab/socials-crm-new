-- ============================================
-- Add Email Validation to Lead Conversion
-- ============================================
-- Issue #4: Primary contact email can be NULL during lead conversion
-- The frontend validates contact name but NOT email
-- ============================================

-- Update convert_lead_to_client to validate primary contact email
...
BEGIN
  ...
  -- NEW: Validate primary contact has email
  ...
  -- 5. Create primary contact (using validated email)
  INSERT INTO client_contacts (
    ...
    v_primary_email,  -- Use validated email
...
DO $$
BEGIN
  RAISE NOTICE 'Updated convert_lead_to_client:';
  RAISE NOTICE '  - Added validation for primary contact email (required)';
