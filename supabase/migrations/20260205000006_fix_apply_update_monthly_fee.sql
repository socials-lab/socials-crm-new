-- Fix apply_modification_request to update engagement monthly_fee after service changes
-- This keeps the engagement.monthly_fee in sync with the sum of active services
