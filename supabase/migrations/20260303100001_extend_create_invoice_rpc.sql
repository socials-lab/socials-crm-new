-- Migration: Extend create_invoice_with_items for Creative Boost and currency validation
-- Single canonical RPC for invoice creation; drop old overload

-- Drop old 10-arg overload (no extra_work_ids, one_off_service_ids)
DROP FUNCTION IF EXISTS create_invoice_with_items(UUID, TEXT, UUID, TEXT, INT, INT, JSONB, NUMERIC, TEXT, UUID);

-- Replace with extended function: Creative Boost support + currency validation
