-- Migration: Add creative_boost_client_month_id to invoice_line_items insert in RPC
-- Also adds the column to invoice_line_items if missing

ALTER TABLE invoice_line_items ADD COLUMN IF NOT EXISTS creative_boost_client_month_id UUID REFERENCES creative_boost_client_months(id);
